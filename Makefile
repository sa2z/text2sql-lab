...
test:
	...
	@echo ""
	@echo "Testing Ollama..."
	@curl -s http://localhost:11435/api/tags > /dev/null && echo "✓ Ollama is ready" || echo "✗ Ollama is not ready"
	@echo ""
	@echo "Testing JupyterLab..."
	@curl -s http://localhost:8889 > /dev/null && echo "✓ JupyterLab is ready" || echo "✗ JupyterLab is not ready"
	@echo ""
	@echo "Testing Open-WebUI..."
	@curl -s http://localhost:3002 > /dev/null && echo "✓ Open-WebUI is ready" || echo "✗ Open-WebUI is not ready"
	@echo ""
