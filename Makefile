...
test:
	...
	@curl -s http://localhost:8888 > /dev/null && echo "✓ JupyterLab is ready" || echo "✗ JupyterLab is not ready"
	@echo ""
	@echo "Testing Open-WebUI..."
	@curl -s http://localhost:3000 > /dev/null && echo "✓ Open-WebUI is ready" || echo "✗ Open-WebUI is not ready"
	@echo ""
