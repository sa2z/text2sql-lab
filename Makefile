...
test:
	...
	@echo ""
	@echo "Testing Ollama..."
	@curl -s http://localhost:51435/api/tags > /dev/null && echo "✓ Ollama is ready" || echo "✗ Ollama is not ready"
	@echo ""
	@echo "Testing JupyterLab..."
	@curl -s http://localhost:58889 > /dev/null && echo "✓ JupyterLab is ready" || echo "✗ JupyterLab is not ready"
	@echo ""
